 ...
 *
 * Guards the active exam-taking endpoints. Expects the student's anonymous
 ...
 *  - the session is still IN_PROGRESS (rejects resubmits),
 ...
 */
export const validateStudentSession = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
